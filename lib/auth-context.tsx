  ...
  useEffect(() => {
    const initializeAuth = async () => {
      try {
        ...
        const supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVjbWhoYnpmbGpza2Vsb2JmZ2RtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTM5NDcxOTAsImV4cCI6MjA2OTUyMzE5MH0.2FEhEcPy7TGTh_8DDohUpIrrrBgtc9iJWiEK5yutIhA
