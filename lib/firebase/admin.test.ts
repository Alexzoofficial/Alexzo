...
describe('Firebase Admin SDK Initialization', () => {
  ...
  it('should throw an error from getAdminFirestore when credentials are not configured', () => {
    ...
    expect(console.warn).toHaveBeenCalledWith('Firebase admin credentials not configured. Server-side operations will be disabled. See ENVIRONMENT_SETUP.md for instructions.');
  });
