-- ==================================================================
-- FINAL DATABASE SCHEMA FOR ALEXZO AI-POWERED PLATFORM
-- Date: 2025-09-11
-- Description: Complete database schema optimized for Google OAuth authentication
-- ==================================================================

-- ==================================================================
-- 1. USER PROFILES TABLE (Google OAuth optimized)
-- ==================================================================
...
-- ==================================================================
-- 2. USER CREATION FUNCTION (Google OAuth optimized)
-- ==================================================================
...
CREATE POLICY "Allow newsletter updates" ON newsletter_subscriptions
...
CREATE POLICY "Admin can manage waitlist" ON waitlist_submissions
...
CREATE INDEX IF NOT EXISTS idx_api_analytics_hour ON api_analytics(hour);

-- ==================================================================
-- 8. GENERATED CONTENT TABLE (AI-generated images, content, etc.)
-- ==================================================================
...
CREATE POLICY "System can track usage" ON user_usage
  FOR INSERT WITH CHECK (true);
...
-- ==================================================================
-- 10. BLOG POSTS TABLE (for dynamic blog content)
-- ==================================================================
...
SELECT 
  ...
  COALESCE(SUM(a.requests_count), 0) as total_api_requests,
  COALESCE(SUM(gc.cost), 0) as total_generation_cost
FROM profiles p
LEFT JOIN apis a ON p.id = a.user_id AND a.status = 'active'
LEFT JOIN generated_content gc ON p.id = gc.user_id AND gc.status = 'generated'
...
-- ==================================================================
COMMENT ON TABLE profiles IS 'User profiles with Google OAuth support';
...
COMMENT ON TABLE user_usage IS 'User feature usage tracking';
COMMENT ON TABLE blog_posts IS 'Dynamic blog content management';
