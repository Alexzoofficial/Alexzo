...
import { ArrowLeft, Download, Wand2, ImageIcon, Loader2 } from "lucide-react"
...
export default function ZyfooxPage() {
  ...
  const generateImage = async () => {
    ...
    try {
      ...
      // Wait for the actual image to load before hiding the loading state
      ...
      <header className="relative z-50 p-6 flex justify-between items-center">
        <Link href="/" className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <span className="text-xl font-bold">Zyfoox AI Image Generator</span>
          </div>
        </Link>
      </header>
